...
<footer>
    <div className="footer">
        ...
        <div className="footer__bottom">
            <span className="bottom__copy">Denteez Copyright 2015</span>
            <ul className="bottom__menu">
                <li className="bottom__menu__item"><a href="#">Support</a></li>
                <li className="bottom__menu__item"><a href="#">Privacy Policy</a></li>
                <li className="bottom__menu__item"><a href="#">Terms of use</a></li>
            </ul>
        </div>
    </div>
</footer>);